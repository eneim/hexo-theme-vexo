...
_.extend(BaseTheme.prototype, {
  ...
  draw: function(container) {
    ...
    var svgImgs = container.getElementsByTagName('svg');
    Array.from(svgImgs).forEach(element => {
      var bBox = element.getBBox();
      element.setAttribute('viewBox', 0 + ' ' + 0 + ' ' + (bBox.width + bBox.x + DIAGRAM_MARGIN * 2) + ' ' + (bBox.height + bBox.y + DIAGRAM_MARGIN * 2));
